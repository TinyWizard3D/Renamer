...
class RenameUI(QWidget):
	...
	def initUI(self):
		...
		#self.renameText.setToolTip(data.renameTltp)
		...
		#self.replaceText.setToolTip(data.replaceTltp)
		...
		#self.suffDropdown.setToolTip(data.suffTltp)
		...
		#paddingLabel.setToolTip(data.paddingTltp)
		...
		#self.paddingStart.setToolTip(data.startTltp)
		...
		#stepLabel.setToolTip(data.stepTltp)
		...
		#self.stepAmount.setToolTip(data.stepTltp)
		...
		genf.setButton(self.defaultBtn, self.layout, checked=True, checkable=True, tooltip=data.defaultTltp, isIcon=True, iconName="defaultIcon")
		self.capGroup.addButton(self.defaultBtn)

		# Uppercase button
		self.uppercaseBtn = QPushButton(self)
		genf.setButton(self.uppercaseBtn, self.layout, checkable=True, tooltip=data.uppercaseTltp, isIcon=True, iconName="upperIcon")
		self.capGroup.addButton(self.uppercaseBtn)

		# Lowercase button
		self.lowercaseBtn = QPushButton(self)
		genf.setButton(self.lowercaseBtn, self.layout, checkable=True, tooltip=data.lowercaseTltp, isIcon=True, iconName="lowerIcon")
		self.capGroup.addButton(self.lowercaseBtn)

		# Capitalize button
		self.capitalizeBtn = QPushButton(self)
		genf.setButton(self.capitalizeBtn, self.layout, checkable=True, tooltip=data.capitalizeTltp, isIcon=True, iconName="capitalIcon")
		...
		genf.setButton(renameBtn, self.layout, text="Rename", tooltip=data.renameTltp, isMainBtn=True, iconName="renameIcon")
		...
		#self.autoSuffixBtn.setToolTip(data.autoSuffixTltp)
